...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql://postgres:postgrespassword@postgres:5432/evolution"
    lid_phone_map: str = ""
    ...
    waha_webhook_url: Optional[str] = "http://orc-backend-n48s7m:3000/webhook/wa-bot"
