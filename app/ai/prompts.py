...
{"action":"create|rename|update_status|rename_and_status|update_profile|none","title":"judul tiket persis seperti disebut user","new_title":"judul baru (rename saja)","new_status":"Not started|In progress|Need to review|Need to fix|Done|Blocking (update_status/rename_and_status saja)","division":null,"priority":"Medium","description":null,"field":"name|nickname|phone|telegram|null","value":"nilai baru untuk update_profile atau null"}
...
- keduanya sekaligus pada tiket -> rename_and_status
