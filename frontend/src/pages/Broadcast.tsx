  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {/* Tab Switcher - Scrollable horizontally for narrow screens */}
        <div className="flex items-center p-1 bg-slate-100 rounded-xl border border-slate-200/80 overflow-x-auto max-w-full">
          <button
            onClick={() => setActiveTab('create')}
            className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer whitespace-nowrap ${
              activeTab === 'create'
          ...
          <button
            ...
            className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer relative whitespace-nowrap ${
              activeTab === 'status'
                ? 'bg-white text-indigo-600 shadow-xs'
                : 'text-slate-600 hover:text-slate-900'
            }`}
      ...
      {selectedJobForModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-4xl w-full max-h-[92vh] flex flex-col overflow-hidden animate-in fade-in duration-150">
            {/* Modal Header */}
            <div className="p-3.5 sm:p-5 border-b border-slate-200 flex items-start justify-between gap-3">
              ...
              <button
                ...
                className="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer shrink-0"
              >
            ...
            <div className="p-3.5 sm:p-5 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                <div className="p-2.5 sm:p-3 rounded-lg border border-slate-200 bg-slate-50/60 text-center">
                  <div className="text-[11px] sm:text-xs text-slate-500 font-medium">Total Penerima</div>
                  <div className="text-base sm:text-lg font-bold text-slate-900 mt-0.5">
                    {selectedJobForModal.total}
                  </div>
                </div>
                <div className="p-2.5 sm:p-3 rounded-lg border border-emerald-200 bg-emerald-50/50 text-center">
                  <div className="text-[11px] sm:text-xs text-emerald-700 font-medium">Berhasil Terkirim</div>
                  <div className="text-base sm:text-lg font-bold text-emerald-800 mt-0.5">
                    {selectedJobForModal.sent}
                  </div>
                </div>
                <div className="p-2.5 sm:p-3 rounded-lg border border-red-200 bg-red-50/50 text-center">
                  <div className="text-[11px] sm:text-xs text-red-700 font-medium">Gagal Terkirim</div>
                  <div className="text-base sm:text-lg font-bold text-red-800 mt-0.5">
                    {selectedJobForModal.failed}
                  </div>
                </div>
                <div className="p-2.5 sm:p-3 rounded-lg border border-slate-200 bg-slate-50/60 text-center">
                  <div className="text-[11px] sm:text-xs text-slate-500 font-medium">Tingkat Sukses</div>
                  <div className="text-base sm:text-lg font-bold text-indigo-700 mt-0.5">
